...
public final class ARG extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        advTab = api.createAdvancementTab("...");
        AdvancementDisplay rootDisplay = new AdvancementDisplay(Material.ENDER_EYE, "...", AdvancementFrameType.TASK, true, false, 0, 0, "It beckons...");
